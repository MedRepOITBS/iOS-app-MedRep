...
@interface MRPHProfileDetailsViewController ()<UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
...
@implementation MRPHProfileDetailsViewController
